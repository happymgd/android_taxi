...
public class URLHelper {
    ...
    public static final String APP_URL = "https://play.google.com/store/apps/details?id=com.taxiapp.partners";
    public static final String HELP_URL = "https://stueps.com/";
