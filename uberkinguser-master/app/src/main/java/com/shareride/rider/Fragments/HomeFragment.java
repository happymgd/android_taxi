package com.shareride.rider.Fragments;
/**
 * @Developer Faysal
 * @Company AAPBD
 **/
...
import com.shareride.rider.BorakhApplication;
...
import com.shareride.rider.Activities.CustomGooglePlacesSearch;
import com.shareride.rider.Activities.Payment;
import com.shareride.rider.Helper.URLHelper;
import com.squareup.picasso.Picasso;
import com.shareride.rider.Activities.HistoryActivity;
import com.shareride.rider.Activities.ShowProfile;
import com.shareride.rider.Helper.ConnectionHelper;
import com.shareride.rider.Helper.CustomDialog;
import com.shareride.rider.Helper.DataParser;
import com.shareride.rider.Helper.SharedHelper;
import com.shareride.rider.Models.CardInfo;
import com.shareride.rider.Models.Driver;
import com.shareride.rider.Models.PlacePredictions;
import com.shareride.rider.R;
import com.shareride.rider.Retrofit.ApiInterface;
import com.shareride.rider.Retrofit.ResponseListener;
import com.shareride.rider.Retrofit.RetrofitClient;
import com.shareride.rider.Utils.MapAnimator;
import com.shareride.rider.Utils.MyBoldTextView;
import com.shareride.rider.Utils.MyButton;
import com.shareride.rider.Utils.MyTextView;
import com.shareride.rider.Utils.Utilities;
...
import static com.shareride.rider.BorakhApplication.trimMessage;
...
//                            }
    ...
    public void sendRequest() {
        ...
        BorakhApplication.getInstance().cancelRequestInQueue("send_request");
        ...
        public void onBindViewHolder(ServiceListAdapter.MyViewHolder holder, final int position) {
            ...
            if (position == currentPostion) {
                ...
                Glide.with(activity).load(jsonArray.optJSONObject(position).optString("image"))
                        .apply(new RequestOptions().placeholder(R.drawable.placeholder).error(R.drawable.placeholder).dontAnimate()).into(holder.serviceImg);
                ...
                Glide.with(activity).load(jsonArray.optJSONObject(position).optString("image"))
                        .apply(new RequestOptions().placeholder(R.drawable.placeholder).error(R.drawable.placeholder)).into(holder.serviceImg);
