...
public class URLHelper {
    ...
    public static final String base = "https://stueps.com/";
...
//
    // without https
     ...
     public static final String client_secret = "8bc8PVqMI5Yhjv6Tsi87gJ5pqQw0JgirSkx0F9SG";   // server side passport credentials

    // https://borakh.aapbd.com/auth/callback

    public static final String STRIPE_TOKEN = "pk_test_NsAaZ1kg8CgevDTgomVlNXlM"; // javaorjava
